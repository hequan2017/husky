...
> 框架 是整个或部分系统的可重⽤用设计，表现为⼀一组抽象构件及构件实例例间交互的⽅方法; 另⼀一种定
义认为，框架是可被应⽤用开发者定制的应⽤用⻣骨架。

> Django是Python下的⼀一款著名的Web框架

* Django优点
    * 自带轮⼦子众多，⽅方便便快速开发 如 Auth, Cache, 模板
    * 天⽣生的MVC设计模式
    * 实⽤用的管理理后台
    * 自带ORM, Template, Form, Auth核⼼心组件
    * 简洁的url设计
    * 周边插件丰富
